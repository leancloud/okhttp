 ...
 *   <li>{@link #readResponseHeaders Read response headers}.
...
public final class HttpTransport implements Transport {
  ...
  public HttpTransport(StreamAllocation allocation, BufferedSource source, BufferedSink sink) {
  ...
  @Override public void disconnect() {
    allocation.connection().disconnect();
  }

  @Override public HttpTransport setHttpEngine(HttpEngine httpEngine) {
  ...
  public void writeRequestHeaders(Request request) throws IOException {
    ...
    String requestLine = RequestLine.get(request, httpEngine.getRoute().getProxy().type());
  ...
  private abstract class AbstractSource implements Source {
    ...
    protected final void endOfInput() throws IOException {
      ...
      detachTimeout(timeout);
      allocation.streamComplete(HttpTransport.this);
      state = STATE_CLOSED;
    }
